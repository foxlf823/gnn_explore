...
class LanguageModel1(nn.Module):
    def __init__(self, data):
        super(LanguageModel1, self).__init__()
    ...
    def calculate_loss(self, word_inputs, feature_inputs, word_seq_lengths, char_inputs, char_seq_lengths, char_seq_recover, batch_label_forward, batch_label_backward, mask,
        ...
        outs = torch.chunk(outs, 2, 2)
        hidden_forward, hidden_backward = outs[0], outs[1]
        ...
        outs_forward = outs_forward.contiguous().view(batch_size * seq_len, -1)
        ...
        outs_backward = outs_backward.contiguous().view(batch_size * seq_len, -1)
